...
public class GeneradorDeEstadisticasTest {
	...
	public void leeTodasLineasDeUnArchivoCsvYDevuelveLaBicicletaMasYMenosUsada() throws IOException{
		...
		*/
		...
		System.out.println("Bicicleta mas usada: " + miGeneradorDeEstadisticas.bicicletaMasUsada(listaDeRecorridos));
		...
		System.out.println("Bicicleta menos usada: " + miGeneradorDeEstadisticas.bicicletaMenosUsada(listaDeRecorridos));
		Assert.assertEquals(452, miGeneradorDeEstadisticas.bicicletaMenosUsada(listaDeRecorridos));
		
	}
	
	@Test
	public void leeTodasLasLineasDeUnArchivoDeRecorridosYDevuelveTiempoPromedioDeUso() throws IOException{
		...
		*/
		...
		System.out.println("Tiempo promedio en minutos: " + miGeneradorDeEstadisticas.tiempoPromedioDeUsoEnMinutos(listaDeRecorridos));
		
		
	}
	
	@Test 
	public void devuelveElRecorridoMasUtilizado() throws IOException{
		...
		//Debe devolver 5;3 corroborado en un excel
		System.out.println("Recorrido mas utilizado par (origen;destino): " + miGeneradorDeEstadisticas.recorridoMasUtilizado(listaDeRecorridos));
